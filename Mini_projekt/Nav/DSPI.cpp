...
void DSPI::init(uint8_t irqErr, uint8_t irqRx, uint8_t irqTx, isrFunc isrHandler)
{
...
void DSPI::setSpeed(uint32_t spd)
{
...
void DSPI::setMode(uint16_t mod)
{
...
void DSPI::setPinSelect(uint8_t pin)
{
...
void DSPI::setTransferSize(uint8_t bits)
{
	switch (bits)
	{
	default:
...
void DSPI::transfer(uint16_t cbReq, uint8_t *pbSnd, uint8_t *pbRcv)
{
...
void DSPI::transfer(uint16_t cbReq, uint8_t *pbSnd)
{
#ifdef ENH_BUFFER
	pspi->sxCon.set = 1 << ENH_BUFFER;
	uint16_t toWrite = cbReq;
...
void DSPI::transfer(uint16_t cbReq, uint8_t bPad, uint8_t *pbRcv)
{
#ifdef ENH_BUFFER
	pspi->sxCon.set = 1 << ENH_BUFFER;
	uint16_t toWrite = cbReq;
...
void DSPI::enableInterruptTransfer()
{
...
void DSPI::disableInterruptTransfer()
{
...
void DSPI::intTransfer(uint16_t cbReq, uint8_t *pbSnd, uint8_t *pbRcv)
{
...
void DSPI::intTransfer(uint16_t cbReq, uint8_t *pbSnd)
{
...
void DSPI::intTransfer(uint16_t cbReq, uint8_t bPadT, uint8_t *pbRcv)
{
...
void DSPI1::enableInterruptTransfer()
{
...
void DSPI1::disableInterruptTransfer()
{
...
void DSPI2::enableInterruptTransfer()
{
...
void DSPI2::disableInterruptTransfer()
{
...
void DSPI3::enableInterruptTransfer()
{
...
void DSPI3::disableInterruptTransfer()
{
