    ...
    #define __PIC32_PPS__
    #define __PIC32_PINS__                20
    #define __PIC32MMXX__
    #define __HAS_USB__
    ...
    #define __NUM_USB_MODULES__           1
    #define __HAS_DMA__
    #define __NUM_DMA_CHANNELS__          15
    #define __HAS_ETHERNET__
    #define __FLASH_ROW__                 512
    #define __FLASH_PAGE__                4096
#endif
    ...
    #define __DDR_SIZE__                  (32 * 1024 * 1204)
    #define __HAS_USB__
    #define __NUM_USB_MODULES__           1
    #define __HAS_GPU__
    #define __HAS_DMA__
