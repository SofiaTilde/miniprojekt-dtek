...
enum opt_code
{
  ...
  OPT_mimadd = 1102,                         /* -mimadd */
  OPT_minterlink_compressed = 1103,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1104,              /* -minterlink-mips16 */
  OPT_mips = 1105,                           /* -mips */
  OPT_mips16 = 1106,                         /* -mips16 */
  OPT_mips16e = 1107,                        /* -mips16e */
  OPT_mips3d = 1108,                         /* -mips3d */
  OPT_mit_ = 1109,                           /* -mit= */
  OPT_mjals = 1110,                          /* -mjals */
  OPT_mlegacy_libc = 1111,                   /* -mlegacy-libc */
  ...
  OPT_mvr4130_align = 1168,                  /* -mvr4130-align */
  OPT_mxc32cpp_lib = 1169,                   /* -mxc32cpp-lib */
  OPT_mxgot = 1170,                          /* -mxgot */
  OPT_n = 1171,                              /* -n */
  OPT_no_canonical_prefixes = 1172,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1173,              /* -no-integrated-cpp */
  OPT_noasmopt = 1174,                       /* -noasmopt */
  ...
  /* OPT_print_mchp_search_dirs = 1191, */   /* -print-mchp-search-dirs */
  ...
  OPT_quiet = 1201,                          /* -quiet */
  OPT_r = 1202,                              /* -r */
  OPT_remap = 1203,                          /* -remap */
  OPT_s = 1204,                              /* -s */
  OPT_s_bc_abi = 1205,                       /* -s-bc-abi */
  OPT_save_temps = 1206,                     /* -save-temps */
  OPT_save_temps_ = 1207,                    /* -save-temps= */
  OPT_shared = 1208,                         /* -shared */
  OPT_shared_libgcc = 1209,                  /* -shared-libgcc */
  /* OPT_specs = 1210, */                    /* -specs */
  OPT_specs_ = 1211,                         /* -specs= */
  OPT_static = 1212,                         /* -static */
  OPT_static_libasan = 1213,                 /* -static-libasan */
  OPT_static_libgcc = 1214,                  /* -static-libgcc */
  OPT_static_libgcj = 1215,                  /* -static-libgcj */
  OPT_static_libgfortran = 1216,             /* -static-libgfortran */
  OPT_static_libgo = 1217,                   /* -static-libgo */
  OPT_static_libstdc__ = 1218,               /* -static-libstdc++ */
  OPT_static_libtsan = 1219,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1220, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1221, */                /* -std=c++0x */
  OPT_std_c__11 = 1222,                      /* -std=c++11 */
  OPT_std_c__1y = 1223,                      /* -std=c++1y */
  ...
  OPT_std_gnu__1y = 1239,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1240,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1241,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1242, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1243, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1244,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1245,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1246, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1247, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1248,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1249, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1250, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1251, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1252,                     /* -std=legacy */
  OPT_symbolic = 1253,                       /* -symbolic */
  OPT_t = 1254,                              /* -t */
  OPT_time = 1255,                           /* -time */
  OPT_time_ = 1256,                          /* -time= */
  OPT_traditional = 1257,                    /* -traditional */
  OPT_traditional_cpp = 1258,                /* -traditional-cpp */
  OPT_trigraphs = 1259,                      /* -trigraphs */
  OPT_u = 1260,                              /* -u */
  OPT_undef = 1261,                          /* -undef */
  OPT_v = 1262,                              /* -v */
  OPT_version = 1263,                        /* -version */
  OPT_w = 1264,                              /* -w */
  OPT_wrapper = 1265,                        /* -wrapper */
  OPT_x = 1266,                              /* -x */
  OPT_z = 1267,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
